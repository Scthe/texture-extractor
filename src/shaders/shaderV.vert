...
void main() {
  ...
  */
  ...
  // vec2 miniPlaneSize = vec2(0.5f, 1.0f); // TODO debug
  ...
  // v_uv = vec2(u_uv_X[vertIdxInMiniPlane], u_uv_Y[vertIdxInMiniPlane]);
  // v_uv = vec2(
    // mix(),
    // vertIdxInMiniPlane == 2 || vertIdxInMiniPlane == 3 ? 1.0f : 0.0f
  // );
}